...
function newCaseNote($text = ''){
  ...
  if(isset($_SESSION['username'])){
    ...
    $returnString .= "<tr><td colspan=2 style='width: 600px; height: 400px;'><textarea name='newCaseNoteContent' style='width: 598px; height: 100%;'>".$text."</textarea></td></tr>";
